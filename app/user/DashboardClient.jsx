            ...
            try {
                ...
                if (mounted) {
                    setWallet({
                        ...
                        depositWallet: data?.wallet?.depositWallet ?? 0,
    ...
    return (
        <div className="relative mx-auto w-[360px] min-h-screen bg-[#121212]">
            ...
            <div className="relative z-10 pt-4 space-y-4">
                ...
                <UserAmountSummaryCard title="Level Income" amount={fmt(wallet.levelWallet)} />
            ...
            {/* TASK CARDS */}
            <TaskCard tag="A1" icon="/tcardimage.png" order="16.00 / Each Order" tasks="Daily Tasks : 01" deposit="Deposit : 25.00$" />
            <TaskCard tag="A2" icon="/tcardimage.png" order="16.00 / Each Order" tasks="Daily Tasks : 02" deposit="Deposit : 75.00$" />
            <TaskCard tag="A3" icon="/tcardimage.png" order="16.00 / Each Order" tasks="Daily Tasks : 03" deposit="Deposit : 125.00$" />
        </div>
    );
}
